...
<div class="mainWrap">
    <h4 class="cont_title"><span>编辑角色<a href="javascript:void(0)" id="backbtn" class="button">返回</a></span></h4>
...
<script>
    function article() {
        $.post('/hzzadmin/<?echo $slider_tag;?>/role', {
                id: $('#id').val()
            },
            function (res) {
                if (res.status != 'false') {
    ...
    $('#save').bind('click', function(){
        $.ajax({
            url:"/hzzadmin/<?echo $slider_tag;?>/roleUpdate",
