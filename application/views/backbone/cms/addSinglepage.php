...
<div class="mainWrap">
    <h4 class="cont_title"><span>添加单页<a href="javascript:void(0)" id="backbtn" class="button">返回</a></span></h4>
    <div class="row" style="margin-top:20px;padding-bottom: 40px">
        <form id="datares" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-input-mid" id="key" name="key" placeholder="标识">
                </div>
            </div>
            <div class="form-group">
...
<script>
    ...
    $('#save').bind('click', function(){
        ...
        $.ajax({
            url:"/hzzadmin/cms/singlepageAdd",
