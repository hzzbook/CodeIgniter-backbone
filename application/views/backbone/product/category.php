    ...
    <div class="return_box">
        <div class="search_box">
            <div class="text_inputs">
                <a href="/b_product_categoryAddPage.html" class="button" style="background: #ffcc33">添加产品分类</a>
                <span>父分类：</span>
...
<script id="demo" type="text/html">
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <a class="button" href="/b_product_categoryUpdatePage.html?id={{d.data[i].id}}">编辑</a>
...
<script>
    ...
    $(document).on("click", ".deleteArticle", function () {
        ...
        layer.msg('你确定删除该文章？', {
            ...
            ,btn: ['确定删除', '取消']
            ,yes: function(index){
                $.post('/hzzadmin/product/categoryDelete', {
                    id: $id
                }, function(res){
                    if (res.status == 'true')
                    {
