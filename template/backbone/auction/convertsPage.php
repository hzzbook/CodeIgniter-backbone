<div class="mainWrap">
    <h4 class="cont_title"><span>积分兑换列表</span></h4>

    <div class="return_box">
    <div class="search_box">
        <div class="text_inputs">
            <a href="/b_auction_convertAddPage.html" class="button" style="background: #ffcc33">添加积分兑换</a>
        </div>
    </div>
...
<script id="demo" type="text/html">
    <table class="table table-bordered table-hover">
        ...
        {{# for(var i = 0, len = d.data.length; i < len; i++){ }}
            ...
            <td>
                <a class="button" href="/b_auction_convertsPage.html?id={{d.data[i].id}}">编辑</a>
...
<script>
    function demo(curr){
        $.post('/hzzadmin/auction/converts', {
