<div class="mainWrap">
    <h4 class="cont_title"><span>轮播列表</span></h4>

    <div class="return_box">
    <div class="search_box">
        <div class="text_inputs">
            <a href="/b_cms_bannerAddPage.html" class="button" style="background: #ffcc33">添加banner</a>
        </div>
    </div>
...
<script id="demo" type="text/html">
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td>{{ d.data[i].url }}</td>
            <td><img src="{{ d.data[i].imgsrc }}" width="100" /> </td>
            <td>{{ d.data[i].status }}</td>
            <td>
                <a class="button" href="/b_cms_bannerUpdatePage.html?id={{d.data[i].id}}">编辑</a>
...
<script>
    ...
    $(document).on("click", ".deleteArticle", function () {
        ...
        layer.msg('你确定删除该文章？', {
            ...
            ,btn: ['确定删除', '取消']
            ,yes: function(index){
                $.post('/hzzadmin/cms/bannerDelete', {
                    id: $id
                }, function(res){
                    if (res.status == 'true')
                    {
