...
<link rel="stylesheet" href="/assetked/themes/default/default.css" />
...
<div class="mainWrap">
    <h4 class="cont_title"><span>添加Banner<a href="javascript:void(0)" id="backbtn" class="button">返回</a></span></h4>
    <div class="row" style="margin-top:20px;padding-bottom: 40px">
        <form id="datares" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-input-mid" id="ordernum" name="ordernum" value="50">
                </div>
            </div>
            <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">url：</label>
                <div class="col-sm-10">
                    <input type="text" class="form-input-mid" id="url" name="url" placeholder="url">
                </div>
            </div>
            <div class="form-group">
