...
<div class="mainWrap">
    <h4 class="cont_title"><span>编辑分类<a href="/b_product_categoryPage.html" class="button">返回</a></span></h4>
...
<script>
    ...
    function article() {
        $.post('/hzzadmin/product/category', {
                id: $('#id').val()
            },
            function (res) {
                if (res.status != 'false') {
    ...
    $('#save').bind('click', function(){
        ...
        $.ajax({
            url:"/hzzadmin/product/categoryUpdate",
